...
void drawCantor(GWindow &w, int order, GPoint left, GPoint right) {
    // Base case: simplest possible version of this problem
    // if order is 0 do nothing
    if (order == 0){
        return;
    }
